  ...
  return (
    <div className="container mt-md-4 mt-5">
      <div className="row d-flex justify-content-center align-items-center">
        ...
        <div className="col-md-6 mr-2" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1000" >
        ...
        <div className="col-md-6 mt-2 mt-md-0 ps-3 pe-3 p-md-0" data-aos="fade-down" data-aos-anchor-placement="top-bottom" data-aos-duration="1000">
